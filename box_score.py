...
class BoxScore(object):
    ...
    def __init__(self, data, pro_schedule, positional_rankings, week):
        ...
        self.home_lineup = [BoxPlayer(player, pro_schedule, positional_rankings, week, self.home_team) for player in home_roster]
        
        away_roster = data['away']['rosterForCurrentScoringPeriod']['entries']
        self.away_lineup = [BoxPlayer(player, pro_schedule, positional_rankings, week, self.away_team) for player in away_roster]
